...
import { M as MarkdownCode, P as css_units, Q as copy, I as IconButton, R as Check, U as Copy, B as Block, S as Static } from "./2.CWSJHAMp.js";
import { I as IconButtonWrapper } from "./IconButtonWrapper.DkpBG_NJ.js";
import { default as default2 } from "./Example.BV0hF1Qv.js";
  ...
  return {
    ...
    h() {
      ...
      set_style(
        ...
        ((_b = ctx[11]) == null ? void 0 : _b.status) !== "pending" ? css_units(
          /*min_height*/
          ctx[3]
        ) : void 0
      );
    ...
    p(ctx2, [dirty]) {
      ...
      2568 || style_changed) {
        set_style(
          ...
          ((_b = ctx2[11]) == null ? void 0 : _b.status) !== "pending" ? css_units(
            /*min_height*/
            ctx2[3]
          ) : void 0
        );
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      8192)
        ...
        ctx2[13];
      if (dirty & /*$$scope, padding, loading_status, value, elem_classes, visible, rtl, latex_delimiters, sanitize_html, line_breaks, header_links, show_copy_button, theme_mode, gradio*/
      2312190) {
