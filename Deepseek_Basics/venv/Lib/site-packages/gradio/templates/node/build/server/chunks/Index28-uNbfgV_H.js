...
import { B as Block, S as Static, W as BlockTitle } from './2-BgvxP-qP.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Block, "Block").$$render(
    ...
    {
      default: () => {
        return `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} <label class="${["block svelte-7ha85a", container ? "container" : ""].join(" ").trim()}">${validate_component(BlockTitle, "BlockTitle").$$render($$result, { show_label, info }, {}, {
          default: () => {
            return `${escape(label)}`;
          }
...
//# sourceMappingURL=Index28-uNbfgV_H.js.map
