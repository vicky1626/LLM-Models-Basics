...
import { B as Block, S as Static, j as BlockLabel, C as Chat, o as IconButtonWrapper, q as IconButton, z as Community, A as Trash, G as Image, H as MarkdownCode, M as Music, J as File$1, K as Copy, N as Check, O as Clear, R as Retry, P as Undo, Q as Edit, V as DropdownCircularArrow } from './2-BgvxP-qP.js';
...
const Examples = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="placeholder-content svelte-9pi8y1" role="complementary">${placeholder !== null ? `<div class="placeholder svelte-9pi8y1">${validate_component(MarkdownCode, "Markdown").$$render($$result, { message: placeholder, latex_delimiters }, {}, {})}</div>` : ``} ${examples !== null ? `<div class="examples svelte-9pi8y1" role="list">${each(examples, (example, i) => {
...
const ChatBot = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    })}</div>` : ``}`}</div>` : `${validate_component(Examples, "Examples").$$render($$result, { examples, placeholder, latex_delimiters }, {}, {})}`}</div> ${``}`;
  } while (!$$settled);
  return $$rendered;
});
...
//# sourceMappingURL=Index60-CuluORfo.js.map
