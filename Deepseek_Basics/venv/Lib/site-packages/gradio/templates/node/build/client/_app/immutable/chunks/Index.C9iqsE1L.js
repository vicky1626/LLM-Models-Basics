...
import { y as resolve_wasm_src, I as IconButton, r as Clear, B as Block, S as Static } from "./2.CWSJHAMp.js";
...
function create_default_slot_1$2(ctx) {
  ...
  imageel1 = new ImageEl({
    props: {
      ...
      style: (
        /*style*/
        ctx[22] + "; background: var(--block-background-fill);"
      ),
      transform: "translate(" + /*$transform*/
      ctx[17].x + "px, " + /*$transform*/
      ctx[17].y + "px) scale(" + /*$transform*/
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      4194304)
        ...
        ctx2[22] + "; background: var(--block-background-fill);";
      if (dirty[0] & /*$transform*/
      131072)
