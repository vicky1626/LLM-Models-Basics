...
import { B as Block, S as Static, z as BlockTitle } from "./2.CWSJHAMp.js";
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      512)
        ...
        ctx2[9];
      if (dirty[0] & /*maximum, minimum, step, disabled, label, value, range_input, minimum_value, show_reset_button, number_input, show_label, info, gradio, loading_status*/
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("show_reset_button" in $$props2)
      $$invalidate(15, show_reset_button = $$props2.show_reset_button);
  };
  $$self.$$.update = () => {
