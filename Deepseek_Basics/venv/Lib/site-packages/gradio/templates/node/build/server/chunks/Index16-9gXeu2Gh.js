...
import { B as Block, S as Static, j as BlockLabel, X as Code$2, n as Empty, q as IconButton, K as Copy$1, D as DownloadLink, u as Download$1, o as IconButtonWrapper, Y as getWorkerProxyContext } from './2-BgvxP-qP.js';
...
const lang_map = {
  python: () => import('./index32-WvFbp12C.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index33-D_JOzORE.js'),
      import('./frontmatter-fdlmGLa7.js')
    ]);
  ...
  json: () => import('./index37-5_6AVrDV.js').then((m) => m.json()),
  html: () => import('./index34-kOjhSKFs.js').then((m) => m.html()),
  css: () => import('./index35-B4LIHEuM.js').then((m) => m.css()),
  javascript: () => import('./index36-Cx5uirmX.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index36-Cx5uirmX.js').then(
...
//# sourceMappingURL=Index16-9gXeu2Gh.js.map
