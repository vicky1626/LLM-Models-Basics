import { B as Block, S as Static, o as IconButtonWrapper, F as FullscreenButton, W as BlockTitle, n as Empty, ar as LineChart, al as globals } from './2-BgvxP-qP.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  async function load_chart() {
    ...
    if (!vegaEmbed) {
      vegaEmbed = (await import('./vega-embed.module-DWOCAiK_.js')).default;
    }
    vegaEmbed(chart_element, spec, { actions: false }).then(function(result) {
      view = result.view;
      resizeObserver.observe(chart_element);
    ...
    $$rendered = `${validate_component(Block, "Block").$$render(
      ...
      },
      {
        default: () => {
          ...
          })}` : ``} ${validate_component(BlockTitle, "BlockTitle").$$render($$result, { show_label, info: void 0 }, {}, {
            default: () => {
              return `${escape(label)}`;
            }
...
//# sourceMappingURL=Index27-DEcNFrNH.js.map
